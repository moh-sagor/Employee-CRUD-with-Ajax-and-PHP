jQuery(document).ready(function () {
    ...
    jQuery(document).on("click", "#edit", function () {
        ...
        jQuery.ajax({
            ...
            success: function (res) {
                ...
                jQuery(".salary").val(res.salary);
                jQuery(".desig").val(res.desig);
    ...
    jQuery(document).on("click", "#editmodal", function () {
        ...
        jQuery.ajax({
            ...
            success: function (res) {
                ...
                jQuery(".msalary").val(res.salary);
                jQuery(".mdesig").val(res.desig);
    ...
    jQuery(document).on("click", ".mupdate", function () {
        ...
        var salary = jQuery(".msalary").val();
        var desig = jQuery(".mdesig").val();
